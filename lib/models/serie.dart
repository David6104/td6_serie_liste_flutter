class Serie {
  ...
  /// Supprime les balises HTML présentes dans le résumé TVMaze (<p>, <b>,etc.)
  ...
  factory Serie.fromJson(Map<String, dynamic> json) {
    // Supporte le format TVMaze (clés 'name', 'summary', 'genres','status'…)
    ...
    return Serie(
      ...
      nom: json['name'] as String? ?? json['nom'] as String? ?? 'Sanstitre',
